...
class Tarea:
    ...
    def desde_fila(fila):
        ...
        return Tarea(
            ...
            fecha_fin=fecha_fin,
            hora_inicio='' if not pd_no_es_vacio(fila.get('hora_inicio', '')) else str(fila.get('hora_inicio', '')),
            hora_fin='' if not pd_no_es_vacio(fila.get('hora_fin', '')) else str(fila.get('hora_fin', '')),
